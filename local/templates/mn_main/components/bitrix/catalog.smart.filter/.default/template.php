...
?>
<div class="bx-filter filter-new <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
			...
			<?endif;?>		
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						$arPropDescTitle = CStatic::DescPropCheck($arResult["G_PROPS_ALL"], $arItem["ID"], '');
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						...
						<?if($arPropDescTitle):?>
						<div class="filter-glossary js-filter-glossary">
							...
							<div class="popup-gloss">
								...
								<?if($arPropDesc["PREVIEW_PICTURE"]):?>
									...
									?>
									<img class="filter-glossary__img" src="<?=$arPropDesc["PICTURE"]?>" alt="<?=$arPropDesc["NAME"]?>" />
								<?endif;?>
								<div class="filter-glossary__title"><?=$arPropDesc["NAME"]?></div>
								<?if($arPropDesc["PREVIEW_TEXT"]):?>
									<div class="filter-glossary__text"><?=$arPropDesc["PREVIEW_TEXT"]?></div>
								<?endif;?>
								<a href="/glossary/" title="Перейти в глоссарий" class="filter-glossary__link">Перейти в глоссарий</a>
									...
									<div class="col-xs-12">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="checkbox">
												...
												<?if($arPropDescValue = CStatic::DescPropCheck($arResult["G_PROPS_ALL"], $arItem["ID"], $ar["VALUE"])):?>
												<?//if($arPropDescValue = CStatic::DescProp($arItem["ID"], $ar["VALUE"])):?>
													<div class="filter-glossary js-filter-glossary">
														<div class="icon-gloss"></div>
														<div class="popup-gloss">
														
															<?if($arPropDescValue["PREVIEW_PICTURE"]):?>
																<?
																$arPropDescValue["PICTURE"] = CFile::ResizeImageGet($arPropDescValue["PREVIEW_PICTURE"], array('width'=>226, 'height'=>400), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];	
																?>
																<img class="filter-glossary__img" src="<?=$arPropDescValue["PICTURE"]?>" alt="<?=$arPropDescValue["NAME"]?>" />
															<?endif;?>
															<div class="filter-glossary__title"><?=$arPropDescValue["NAME"]?></div>
															<?if($arPropDescValue["PREVIEW_TEXT"]):?>
																<div class="filter-glossary__text"><?=$arPropDescValue["PREVIEW_TEXT"]?></div>
															<?endif;?>
															<a href="/glossary/" title="Перейти в глоссарий" class="filter-glossary__link">Перейти в глоссарий</a>
