...
<div class="basket__title">Выберите удобный способ доставки</div>
<div class="basket-checkbox">
	<div class="basket-checkbox__inner">



<input type="hidden" class="noCheck" name="BUYER_STORE" id="BUYER_STORE" value="<?=$arResult["BUYER_STORE"]?>" />
<div class="bx_section">
	...
	if(!empty($arResult["DELIVERY"]))
	{
		...
		foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery)
		{
			...
			<div class="basket-checkbox__item" <?=$clickHandler?> >
				<label class="basket-checkbox__label"  >
					...
					<div class="basket-checkbox__cell">
						<img src="<?=$deliveryImgURL?>" alt="" class="basket-checkbox__pic">
					</div>
					<div class="basket-checkbox__cell">
						...
						<div class="bx_description">
							...
							<span class="bx_result_price">
								<?if(isset($arDelivery["PRICE"])):?>
									<?=GetMessage("SALE_DELIV_PRICE");?>: <b><?=(strlen($arDelivery["PRICE_FORMATED"]) > 0 ? $arDelivery["PRICE_FORMATED"] : number_format($arDelivery["PRICE"], 2, ',', ' '))?></b><br />
									<?
