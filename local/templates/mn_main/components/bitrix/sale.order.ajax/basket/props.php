...
<?
	...
	?>
		...
		<!-- begin basket-form -->
		<div class="js-basket_props">		
			<span class="form__title">Доставка <a class="delivery_terms" href="/delivery-and-payment/" target="_blank">Условия доставки<i></i></a></span>
		...
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_ALL"], $arParams["TEMPLATE_LOCATION"]);		
		...
		?>
			...
			<div class="form__row">
				...
				<textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" cols="40" rows="4" class="noCheck"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
