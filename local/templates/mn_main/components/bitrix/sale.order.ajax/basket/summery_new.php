						...
						<div class="order-form__table table">
							...
							<div class="table__items js-product__row">
								...
								<div class="table__item how-many js-change">
									...
									<input type="text" data-basketID="<?=$arElement["ID"]?>" name=""QUANTITY_<?=$arElement["ID"] ?>" value="<?=$arElement["QUANTITY"]?>" class="qt_num js-input_number" />
								...
								<div class="table__item amount">
									...
									<strong class="strong__amount"><?=number_format($arElement["QUANTITY"]*$arElement["PRICE"], 0, '.', ' ')?> руб.</strong>
								</div>
							...
							<div class="table__total">
								Итого:
								<strong><?=number_format($arResult["ORDER_PRICE"], 0, '.', ' ')?> руб.</strong>
							</div>
...
if($_GET["mode"]) {
	...
	$APPLICATION->IncludeComponent(
		...
		"tovs.list.dontforget",
		Array(
			"EC_TYPE" => 'Basket Accessory',
			"ADD_TITLE" => "Не забудьте купить",
			"CAN_BUY" => "Y",
