...
foreach($arResult["ITEMS"] as $key => &$arElement)
{
	...
	// ############################################################################	
					...
					if($picture) {
						...
						$arElement["IMG_1"] = CFile::ResizeImageGet($picture, array('width'=>55, 'height'=>100), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];	
						/*
						$arElement["IMG_2"] = CFile::ResizeImageGet($picture, array('width'=>110, 'height'=>200), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];	
						$arElement["IMG_3"] = CFile::ResizeImageGet($picture, array('width'=>165, 'height'=>300), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];
						*/
					}	
