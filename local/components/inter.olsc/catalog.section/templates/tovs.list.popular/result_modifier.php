...
$arProps = array();
		...
		$arFilter = array(
			"IBLOCK_ID" => CStatic::$iconsIdBlock,
			"ACTIVE" => "Y",
		);
		
		
		$arResult["ICONS_ALL"] = CStatic::GetElementList($arFilter, false, array("SORT" => "ASC"), true, true);
...
foreach($arResult["ITEMS"] as $key => &$arElement)
{
	...
	// ############################################################################	
					...
					//pre($picture);
					if($picture) {
						$arElement["IMG_1"] = CFile::ResizeImageGet($picture, array('width'=>205, 'height'=>260), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];	
						$arElement["IMG_2"] = CFile::ResizeImageGet($picture, array('width'=>410, 'height'=>520), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];	
						$arElement["IMG_3"] = CFile::ResizeImageGet($picture, array('width'=>615, 'height'=>780), BX_RESIZE_IMAGE_PROPORTIONAL, true)["src"];
					}	
