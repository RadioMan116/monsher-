...
<?if($arResult["ITEMS"]):?>
						...
						<div class="special-offers similar-models">
							<div class="container">
								...
								<div class="catalog swiper-container swiper-container-four">
	...
	<div class="catalog__item swiper-slide special-offers__slide js-ecom_product-item" data-id="<?=$arElement['ID']?>"  id="<?=$this->GetEditAreaId($arElement['ID']);?>">
		...
		<a class="catalog__pic" href="<?=$arElement["DETAIL_PAGE_URL"]?>" title="<?=$arElement["NAME"]?>">												
			<img data-src="<?=$arElement["IMG_1"]?>" data-srcset="<?=$arElement["IMG_2"]?> 2x,<?=$arElement["IMG_3"]?> 3x" alt="<?=$arElement["NAME"]?> preview 1" title="<?=$arElement["NAME"]?> фото 1" class="special-offers__img catalog__img lazyload" />
		</a>
